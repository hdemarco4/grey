...
<meta name="description" content="Spiral earrings-Bronze">
<meta property="og:title" content="Grey Raven's Castle - Product">
<meta property="og:description" content="Spiral earrings-Bronze">
</head>
  ...
  <main class="container">
    ...
    ?>
      ...
      <div class="col middle pt-3 ps-4 border-sm-bottom border-md-bottom-0">
        <h3> Spiral earrings-Bronze </h3>



        <p>The price for this piece is $75.30</p>
        <button class="snipcart-add-item btn btn-outline-dark prod" 
          data-item-id="H10034-3" 
          data-item-name="Spiral earrings-Bronze" 
          data-item-price="75.30"
          data-item-url="https://greyravenscastle.com/HJewelry/H10034-3.php" 
          data-item-description="Spiral earrings-Bronze"
          data-item-image="../pics/H10034-3-1 bc.JPG" 
          data-item-weight="85" 
          data-item-width="12"
          data-item-length="20" 
          data-item-height="2" 
