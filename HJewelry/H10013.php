...
<meta name="description" content="A grey clay pendant with 3 embedded stones on a dark pink ribbon.">
<meta property="og:title" content="Grey Raven's Castle - Product">
<meta property="og:description" content="A grey clay pendant with 3 embedded stones on a dark pink ribbon.">
</head>
  ...
  <main class="container">
    ...
    ?>
      ...
      <div class="col middle pt-3 ps-4 border-sm-bottom border-md-bottom-0">
        <h3> Grey clay pendant 1 1/4 long, round </h3>
        ...
        <button class="snipcart-add-item btn btn-outline-dark prod" 
          data-item-id="H10013" 
          data-item-name="Grey clay pendant 1 1/4 long, round" 
          data-item-price="15.00"
          data-item-url="https://greyravenscastle.com/HJewelry/H10013.php" 
          data-item-description="A grey clay pendant with 3 embedded stones on a dark pink ribbon."
          data-item-image="../pics/H10013 c.JPG" 
          data-item-weight="85" 
          data-item-width="12"
          data-item-length="20" 
          data-item-height="2" 
        ...
        <p>A grey clay pendant with 3 embedded stones on a dark pink ribbon.</p>
