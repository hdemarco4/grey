  ...
  <main class="container">
    ...
    ?>
      ...
      <div class="col middle pt-3 ps-4 border-sm-bottom border-md-bottom-0">
        <h3> Stone donut pendent wrapped with bronze 2 </h3>
        ...
        <button class="snipcart-add-item btn btn-outline-dark prod" 
          data-item-id="H10053" 
          data-item-name="Stone donut pendent wrapped with bronze 2" 
          data-item-price="75.30"
          data-item-url="https://greyravenscastle.com/HJewelry/H10053.php" 
          data-item-description="Stone donut pendent wrapped with bronze"
          data-item-image="../pics/H10053 c.JPG" 
          data-item-weight="85" 
          data-item-width="12"
          data-item-length="20" 
          data-item-height="2" 
