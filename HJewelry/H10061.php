...
<meta name="description" content="Black stone with brown swirls wrapped with bronze wire">
<meta property="og:title" content="Grey Raven's Castle - Product">
<meta property="og:description" content="Black stone with brown swirls wrapped with bronze wire">
</head>
  ...
  <main class="container">
    ...
    ?>
      ...
      <div class="col middle pt-3 ps-4 border-sm-bottom border-md-bottom-0">
        <h3> Black stone with brown swirls wrapped with bronze wire </h3>
        ...
        <button class="snipcart-add-item btn btn-outline-dark prod" 
          data-item-id="H10061" 
          data-item-name="Black stone with brown swirls wrapped with bronze wire" 
          data-item-price="105.28"
          data-item-url="https://greyravenscastle.com/HJewelry/H10061.php" 
          data-item-description="Black stone with brown swirls wrapped with bronze wire"
          data-item-image="../pics/H10061 c.JPG" 
          data-item-weight="85" 
          data-item-width="12"
          data-item-length="20" 
          data-item-height="2" 
        ...
        <p>Black stone with brown swirls</br>
            Swarovski crystal accent</br>
            Uniquely wrapped with bronze wire</br>
            Pendent hangs about 2 1/2 inches</br>
